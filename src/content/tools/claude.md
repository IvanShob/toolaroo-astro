...
alternatives:
  - name: ChatGPT
    reason: More creative and versatile, strong multimodal abilities
  - name: Perplexity
    reason: Best for research + real-time citations
  - name: Jasper
    reason: Marketing-focused AI for branded content
faqItems:
