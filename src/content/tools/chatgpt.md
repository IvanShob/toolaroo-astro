...
alternatives:
  - name: Claude
    reason: better for long documents and advanced reasoning
  - name: Jasper
    reason: specialised in marketing and brand-consistent copywriting
  - name: Copy.ai
    reason: built for teams creating sales and outreach content
faqItems:
